...
Thanks for your interest and work in easy-di.

## Getting Started

easy-di [open issues are here](https://github.com/eisberg-labs/easy-di/issues). Issues can include bugs to fix, features to add, or documentation that looks outdated. 
